  ...
  return (
    <header className="pt-[clamp(3rem,7vw,6rem)] pb-[2rem]">
      <div className="max-w-[1100px] w-[92vw] mx-auto grid grid-cols-1 md:grid-cols-[1.2fr_1fr] gap-[2rem] items-center">
        <div>
          <p className="text-muted text-[clamp(1rem,1.2vw,1.15rem)]">🚀 Fast setup • 🔒 Secure • ⚙️ Customizable</p>
          ...
          <div className="flex gap-[0.7rem] mt-[1rem] flex-wrap">
            <a href="#contact" className="px-[1rem] py-[0.65rem] rounded-[0.7rem] bg-gradient-to-br from-accent1 to-accent2 text-white font-bold shadow-[0_10px_30px_rgba(31,182,255,0.25)]">Book a Free Consultation</a>
