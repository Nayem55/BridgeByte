    ...
    <header className="pt-[clamp(3rem,7vw,6rem)] pb-[2rem]">
      <div className="max-w-[1100px] w-[92vw] mx-auto grid grid-cols-1 md:grid-cols-[1.2fr_1fr] gap-[2rem] items-center">
        ...
        <div className="flex justify-center md:justify-end">
          <Parallax speed={-5}>
            <img className="w-[340px] max-w-[70vw] drop-shadow-[0_30px_45px_rgba(31,182,255,0.18)]" src="https://i.ibb.co.com/HLBxP2Wv/Screenshot-2025-11-08-150049-removebg-preview.png" alt="BridgeByte mark" />
          </Parallax>
        </div>
      </div>
    </header>
